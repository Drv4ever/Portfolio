...
import { featuredWorks, learningProjects } from "@/data/content";
...
export default function Projects() {
  return (
    <>
        ...
        <Stagger>
          {featuredWorks.map((work, index) => (
            <motion.article
              ...
              className={
                index === featuredWorks.length - 1
                  ? "pb-2"
                  : "border-b border-border-light pb-6 dark:border-border-dark"
              }
            >
      ...
      <Section title="Learning Projects">
        <Stagger>
          {learningProjects.map((work, index) => (
            <motion.article
              key={work.title}
              variants={staggerItem}
              className={
