export const profile = {
  ...
  image: "https://avatars.githubusercontent.com/u/192817774?v=4",
  imageCaption: "Portrait, desk edition.",
  socials: [
    { label: "Email", href: "mailto:dhruvjain632@gmail.com" },
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/dhruv-jain-4284a8263/",
    },
...
export const featuredWorks = [
  ...
  {
    title: "mongo-schema-explainer-mcp",
    description:
      "Production-grade MCP server for safe MongoDB inspection: lists collections, infers schemas from live samples, and runs strictly read-only, allowlisted queries. Built with TypeScript, Zod validation, and Docker-ready deployment.",
    techStack: [
      {
        name: "TypeScript",
        logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg",
      ...
      {
        name: "Zod",
        logo: "https://raw.githubusercontent.com/colinhacks/zod/main/logo/logo.svg",
      },
      {
        name: "Docker",
    ...
    live: "",
    github: "https://github.com/Drv4ever/mongo-schema-explainer-mcp",
  },
];
